...
const styles = StyleSheet.create({
  ...
  card: { borderBottomColor: color.textSecondary, borderBottomWidth: StyleSheet.hairlineWidth, borderLeftColor: color.gold, borderLeftWidth: 2, gap: space.sm, paddingBottom: space.md, paddingLeft: space.md, paddingTop: space.xs },
  ...
  hovered: { opacity: 0.9 },
  link: { color: color.gold, fontFamily: type.family.bodyMedium, fontSize: type.size.caption },
  linkButton: { alignItems: 'center', borderColor: color.gold, borderRadius: space.sm, borderWidth: 1, flex: 1, justifyContent: 'center', minHeight: 44, paddingHorizontal: space.sm },
  meta: { ...tabularNums, color: color.textSecondary, fontFamily: type.family.figure, fontSize: type.size.caption },
  outcome: { ...tabularNums, color: color.gold, fontFamily: type.family.figureBold, fontSize: 10, letterSpacing: 1 },
  pressed: { opacity: 0.82, transform: [{ scale: 0.98 }] },
  row: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' },
  secondaryButton: { alignItems: 'center', borderColor: color.gold, borderRadius: space.sm, borderWidth: 1, justifyContent: 'center', minHeight: 52 },
  secondaryLabel: { color: color.gold, fontFamily: type.family.bodyMedium, fontSize: type.size.body },
